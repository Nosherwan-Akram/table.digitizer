...
class Model: 
	...
	def setupCTC(self):
		...
		if self.decoderType == DecoderType.BestPath:
			...
			wordChars = open('PTR/model/wordCharList.txt').read().splitlines()[0]
			corpus = open('PTR/data/corpus.txt').read()
	...
	def save(self):
		"save model to file"
		self.snapID += 1
		self.saver.save(self.sess, 'PTR/model/snapshot', global_step=self.snapID)
